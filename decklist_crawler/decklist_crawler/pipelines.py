...
class DecklistCrawlerPipeline:
    def process_item(self, item, spider):
        ...
        if deckExists:
            ...
            if print_database == True: 

            	# Syntax error on this line, will have to add some debugging statements for decklist_data to see if its getting populated
            	self.logger.info(f"Deck already recorded, retrieved deck_id {decklist_data['deck_id']}")
